...
<html>
    <head>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            {
             $.ajax({
              url:"updateUsuarios.php",
              method:"POST",
              data:{id:id, column_name:column_name, value:value},
              success:function(data)
              {
               $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
               $('#tU').DataTable().destroy();
               fetch_data();
              }
             });
    ...
    <body>
        <center>
        <div class="container">
            <form class="form-horizontal" action="importarUsuarios.php" method="post" name="upload_excel" enctype="multipart/form-data">
            <table class="table-responsive"> 
                ...
                <tr>
                    <td><br/><button type="submit" name="btnsave" class="form-control" style="color: white;background-color: #40c4ff;height: 30px">
                             <span class="glyphicon glyphicon-save"></span> &nbsp; Salvar Estudantes</button>
                    </td>
                </tr>
            </table>
            </form>
        ...
        <div class="container">
            <table cellpadding="1" cellspacing="1" border="1" class="table-responsive" id="tU"> 
                    <thead>
                        <tr>
                            <th>Username</th>
                            <th>Nome</th>
